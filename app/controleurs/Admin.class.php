...
class Admin extends Routeur
{
  ...
  public function gererEntite() {
    if (isset($_SESSION['oUtilisateur'])) {
      ...
      // } else if (self::$entite == "utilisateur" && self::$action == null){
      //   $entite = ucwords(self::$entite);
      //   $classe = "Admin$entite";
      //   if (class_exists($classe)) {
      //     (new $classe())->gererAction();
  ...
  //     $ajoutUtilisateur = new AdminUtilisateur;
  //     $ajoutUtilisateur->ajouterUtilisateur();
  //   } else {
  //     $connection = new AdminUtilisateur;
  ...
  //       $profile->profileUtilisateur($oUtilisateur); // retour sur la page de liste des utilisateurs
  //       exit;
  //     }
  //   }
  ...
  //       $profile = new AdminUtilisateur;
  //       $profile->profileUtilisateur($this->oUtilisateur);
  //       exit;
  //     } else {
